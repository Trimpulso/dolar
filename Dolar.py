...
# Función para enviar mensajes a Telegram con manejo de errores
...
while True:
    ...
    try:
        ...
        # Validar si hay suficientes filas y columnas en df antes de acceder a posiciones específicas
        if len(df) > 2:
    ...
    # Función para validar y formatear los valores del dólar
    ...
    # Función para verificar y enviar alerta de venta
    def funventa():
    ...
    # Función para verificar y enviar alerta de compra
    def funcompra():
